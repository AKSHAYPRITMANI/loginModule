$(function() {
  'use strict';
  if ($('#morris-line-loginmodule').length) {
    Morris.Line({
      element: 'morris-line-loginmodule',
  ...
  if ($('#morris-area-loginmodule').length) {
    Morris.Area({
      element: 'morris-area-loginmodule',
  ...
  if ($("#morris-bar-loginmodule").length) {
    Morris.Bar({
      element: 'morris-bar-loginmodule',
  ...
  if ($("#morris-donut-loginmodule").length) {
    Morris.Donut({
      element: 'morris-donut-loginmodule',
